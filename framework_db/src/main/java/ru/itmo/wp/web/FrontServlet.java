...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        List<String> afterActionBefore = List.of("before", route.getAction(), "after");
        Method actionMethod = null;
        for (String methodName : afterActionBefore) {
            Method method = null;
            ...
            try {
                ...
                switch (parameterTypes.length) {
                    case 2:
                        ...
                        break;
                    case 1:
                        if (parameterTypes[0].getName().equals("java.util.Map")) {
